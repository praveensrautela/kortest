...
<head>
    ...
    <title></title>
    <?php $this->head() ?>
    <?php include (dirname(__FILE__) . "/../common/frontcss.php"); ?>
</head>
...
End Preloader
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <?php include (dirname(__FILE__) . "/../common/frontheader.php"); ?>
        <?= $content ?>
        <?php include (dirname(__FILE__) . "/../common/frontfooter.php"); ?>
        <?php include (dirname(__FILE__) . "/../common/frontjs.php"); ?>
    </div>
    <?php $this->endBody() ?>
</body>
